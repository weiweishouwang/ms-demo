...
public class ZipUtil {
     ...
     * @return the boolean
     * @throws Exception the jcc exception
     */
    public static boolean zip(String srcPath, String zipPath, String zipFileName) throws Exception {
        ...
        try {
            ...
            IOUtil.deleteFile(zipFilePath);

            cos = new CheckedOutputStream(new FileOutputStream(zipFilePath), new CRC32());
    ...
    public static void main(String[] args) {
        String zipPath = "D:\\maildir";
        String dir = "D:\\maildir\\13_1431584813027";
